...
CREATE TABLE users (
  ...
  role VARCHAR(20) NOT NULL, -- admin/guide/tourist
  status VARCHAR(20) NOT NULL DEFAULT 'active', -- pending/frozen/active
  ...
  lv INT DEFAULT 1,
  exp INT DEFAULT 0,
  avatar_status VARCHAR(20), -- rejected/approved/pending
...
VALUES
('admin','123456','admin','active',10,9999),
('test1','123456','guide','active',1,0),
('test2','123456','tourist','active',1,0);
